...
description: Práticas recomendadas e considerações para o serviço de Automated forms conversion
seo-description: Lista de estilos e padrões em PDF forms de origem que o serviço de Automated forms conversion acha difícil de identificar
...
Este documento fornece orientações e recomendações que podem beneficiar os administradores, autores e desenvolvedores de formulários ao trabalhar com [!DNL Automated Forms Conversion service]. Ele discute as práticas recomendadas, desde a preparação de formulários de origem até a correção de padrões complexos que exigem algum esforço extra para a conversão automatizada. Essas práticas recomendadas contribuem coletivamente para o desempenho e a saída geral do [!DNL Automated Forms Conversion service].

## Práticas recomendadas

O serviço de conversão converte PDF forms disponíveis na instância AEM [!DNL Forms] em formulários adaptáveis. As práticas recomendadas listadas abaixo ajudam você a melhorar a velocidade e a precisão de conversão. Além disso, essas práticas recomendadas ajudam você a economizar tempo gasto em atividades de conversão.
...
* Não carregue os Portfolio [PDF](https://helpx.adobe.com/br/acrobat/using/overview-pdf-portfolios.html). O serviço não converte um Portfolio PDF em um formulário adaptável.
...
* [Adicione ](https://helpx.adobe.com/sign/using/text-tag.html) tags do Adobe Sign ao arquivo XDP. O serviço converte automaticamente as tags Adobe Sign em campos de formulário adaptáveis correspondentes. A Forms adaptativa suporta um número limitado de campos Adobe Sign. Para obter a lista completa dos campos suportados, consulte [Usando o Adobe Sign em uma documentação de formulário adaptável](https://docs.adobe.com/content/help/en/experience-manager-65/forms/adaptive-forms-advanced-authoring/working-with-adobe-sign.html).
...
AEM [!DNL Forms Automated Conversion service] usa algoritmos de aprendizado de máquina e inteligência artificial para entender o layout e os campos do formulário de origem. Cada serviço de aprendizado de máquina aprende continuamente a partir de dados de origem e produz uma saída aprimorada com cada churn. Estes serviços aprendem com a experiência como os humanos.
...
| Padrão | Exemplo |
|--- |--- |
| **O** <br>PatternService não converte PDF forms preenchidos em um formulário adaptável. <br><br>**** <br>ResoluçãoUse formulários adaptativos vazios. | ![Formulário preenchido](assets/best-practice-filled-forms.png) |
| **O** <br>PatternService pode falhar ao reconhecer texto e campos em um formulário denso. <br><br>**** <br> ResoluçãoAumenta a largura entre o texto e os campos de um formulário denso antes de iniciar a conversão. |  |
| **O** <br>PatternService não suporta formulários digitalizados. <br><br>**** <br>ResoluçãoNão use formulários digitalizados. | ![Formulário digitalizado](assets/scanned-forms.png) |
| **O** <br>PatternService não extrai imagens e texto dentro de imagens. <br><br>**** <br> ResoluçãoAdicione manualmente imagens ou texto a formulários convertidos. | ![Imagem com formulário de texto](assets/best-practice-image-with-text.png) |
| **** <br>PadrãoAs tabelas com limites e bordas pontilhados ou não claros não são convertidas. <br><br>**** <br>ResoluçãoUse tabelas com limites e bordas explícitos. suportado. | ![Formulário de tabela não limpo](assets/best-practice-table-dotted-non-clear.png) |
| **** <br> PadrãoOs formulários adaptativos não suportam texto vertical pronto para uso. Portanto, o serviço não converte o texto vertical para o texto Adaptive Forms correspondente. <br><br>**** <br> ResoluçãoUse o editor de formulário adaptável para adicionar texto vertical, se necessário. | ![Formulário de tabela não limpo](assets/vertical-text.png) |
...
| Padrão | Resolução |
|--- |--- |
| **As opções de grupo** <br> de escolha padrão com formas diferentes de caixa ou círculo não são convertidas em componentes de formulário adaptáveis correspondentes. <br><br>**** <br> ResoluçãoAltere as opções de escolha de formas para caixa ou círculo ou use o Editor de revisão e correção para identificar as formas. | ![Campos de escolha  ](assets/best-practice-choice-group-options.png) |

### Campos de formulário {#form-fields}

| Padrão | Resolução |
|--- |--- |
| **O** <br> PatternService não identifica campos sem bordas claras. <br><br>**** <br> ResoluçãoUse o editor de Revisão e Correção para identificar esses campos. | ![campos com limites não claros](assets/best-practice-fields-without-clear-borders.png) |
| **O** <br> Serviço de padrão pode não identificar alguns campos de formulário de grupo de escolha com legendas na parte inferior ou direita de um formulário. <br><br>**** <br> ResoluçãoUse o editor de Revisão e Correção para identificar esses campos | ![Campos de escolha](assets/best-practice-caption-bottom-right.png) |
| **** <br> PatternService mescla ou atribui um tipo errado a alguns campos de formulário que são colocados muito próximos uns dos outros ou que não têm bordas claras. <br><br>**** <br> ResoluçãoUse o editor de Revisão e Correção para identificar esses campos. | ![Campos de escolha](assets/best-practice-placed-very-near.png) |
| **O** <br> PatternService pode falhar ao reconhecer campos com legendas distantes ou uma linha pontilhada entre a legenda e o campo de entrada. <br><br>**** <br> ResoluçãoUse campos de formulários com limites claros ou use o Editor de revisão e correção para corrigir esses problemas. | ![Campos distantes ou linha pontilhada entre o campo de legenda](assets/best-practice-far-away-captions-or-a-dotted-line.png) |

### Listas {#lists}

| Padrão | Resolução |
|--- |--- |
| **** <br>PadrõesAs listas que contêm campos de formulário são mescladas ou não convertidas em componentes de formulário adaptáveis correspondentes  <br><br>**** <br>ResoluçãoUse campos de formulários com limites claros ou use o Editor de revisão e correção para corrigir esses problemas. | ![listas que contêm grupos de escolha](assets/best-practice-lists-containing-form-fields.png) |
| **O** <br>PatternService pode deixar algumas listas aninhadas sem identificação  <br><br>**** <br> ResolutionUse o editor de Revisão e Correção para corrigir esses problemas. | ![listas que contêm grupos de escolha](assets/best-practice-nested-lists.png) |
| **O** <br>   <br><br>**** <br> PatternService mescla algumas listas que contêm grupos de escolha entre siUse o recurso de revisão e correção do editor para corrigir esses problemas. | ![listas que contêm grupos de escolha](assets/best-practice-check-box-in-table-cells.png) |
